<html><head>
    <title>กองออร์โธปิดิคส์และกายอุปกรณ์</title>
    <meta charset="utf-8">
...
<!--ส่วน logo -->
        ...
        <div class="container">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <h4 class="text-center text-success">กองออร์โธปิดิคส์และกายอุปกรณ์</h4>
                <hr>
            </div>
        </div>
		<!--404page-->
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <img src="imageweb/404.png" class="center-block img-responsive img-rounded" width="500" height="200">
                </div>
            </div>
            <br>
		</div>
