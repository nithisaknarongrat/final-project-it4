<html><head>
    <title>ทำเนียบผู้บังคับบัญชา</title>
    <meta charset="utf-8">
...
<!--ส่วน logo -->
        ...
        <div class="container">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <h4 class="text-center text-success">ทำเนียบผู้บังคับบัญชา</h4>
                <hr>
            </div>
        </div>
		<!--ทำเนียบรพ.ผศ.-->
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <img src="imageweb/ทำเนียบรพ.ผศ.(กค60).jpg" class="center-block img-responsive img-rounded" width="100%">
                </div>
            </div>
        <!--ส่วนท้าย-->
